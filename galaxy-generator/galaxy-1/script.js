...
const galaxySize = new Float32Array(count)//size of star
...
for (let i = 0; i < count; i++) {
  ...
  result+=i / count;
  result+="&";
  result+=galaxySeed[i * 3 + 0]+"&"+galaxySeed[i * 3 + 1]+"&"+galaxySeed[i * 3 + 2];
  result+="&";
  result+=Math.random() * 2 + 0.5;
...
const innColor = new Color("#0B20D4")
...
var _btt=document.getElementById("show-data-button");
