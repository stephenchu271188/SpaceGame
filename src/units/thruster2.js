...
class Thruster2{
	constructor(params){
		...
		this._sparks = new EngineSparks({
			...
			//this._sparks._points.position.set(0,0,-10);
			//this._sparks._points.scale.set(0.001,0.001,0.001);
...
class EngineSparks{//chùm tia lửa
  constructor(params) {
    ...
    const uniforms = {
        diffuseTexture: {
            value: new THREE.CanvasTexture(this._game._image_preloader.getImage('particle4'))
        },
        pointMultiplier: {
