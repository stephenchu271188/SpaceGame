...
class SpaceShip6 extends SpaceShip {
	...
	constructor(params){
		...
		//this._visibilityIndex = this._game._visibilityGrid.UpdateItem(
		  ...
		  this._rotate_speed=0.15;//van toc quay
	...
	CheckTarget(timeInSeconds){
		...
		if(this._lock_target===true){
			...
			//this._utils.rotateAboutPoint(this._virtual_object_2,_center,
										 //this._utils.axisZ,timeInSeconds*this._rotate_speed*this._direct, false);
			this._utils.rotateAboutPoint(this._virtual_object_2,_center,
										 this._utils.axisX,timeInSeconds*this._rotate_speed*this._direct, false);								
