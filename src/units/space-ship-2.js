	...
	CheckTarget(timeInSeconds){
		...
		if(_distance<300){
			...
			if(_distance<200)
				...
				let _randX=this._utils.getRandomNumberInRange(2,5);
				let _randY=this._utils.getRandomNumberInRange(2,5);
				let _randZ=this._utils.getRandomNumberInRange(2,5);
