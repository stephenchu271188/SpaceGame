...
//cung cấp một lớp (TerrainChunk) để tạo mesh địa hình cho cảnh Three.js. 
//Phương thức _Rebuild là hàm chính tạo ra hình học và các thuộc tính cho 
//mesh địa hình, trong khi các phương thức khác (Destroy, Hide, Show và _Init) 
//giúp quản lý và điều khiển mesh địa hình.
...
export const terrain_chunk = (function() {
  ...
  class TerrainChunk {
    ...
    *_Rebuild() {
      ...
      const resolution = this._params.resolution;//độ phân giải (có thể là số lượng các mảnh texture)
