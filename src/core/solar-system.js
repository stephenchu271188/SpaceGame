...
class SolarSystem{
	...
	create_earth(){
		let _earth=new Earth({scene: this._game._graphics.Scene,game:this._game});
	...
	create_mars(){
		let _mars=new Planet({scene: this.Scene,radius:this._earth_radius/2,
			position:this._mars_pos,
			altitude_atmosphere:100,
			texture_url:"./texture/marsmap1k.jpg",
	...
	create_neptune(){
		let _neptune=new Planet({scene: this.Scene,radius:this._earth_radius/2,position:this._neptune_pos,
					altitude_atmosphere:100,
					texture_url:"./texture/neptunemap.jpg",
	...
	create_jupiter(){
		let _jupiter=new Planet({scene: this.Scene,radius:this._earth_radius*1.5,position:this._jupiter_pos,
					altitude_atmosphere:100,
					texture_url:"./texture/jupitermap.jpg",
					color_atmosphere:new THREE.Color(0x034d8e)});
	  _jupiter.create();
	...
	create_mercury(){
		let _mercury=new Planet({scene: this.Scene,radius:this._earth_radius/3,position:this._mercury_pos,
					altitude_atmosphere:100,
					texture_url:"./texture/mercurymap.jpg",
					color_atmosphere:new THREE.Color(0x034d8e)});
	  _mercury.create();
	...
	create_venus(){
		let _venus=new Planet({scene: this.Scene,radius:this._earth_radius/2,position:this._venus_pos,
					altitude_atmosphere:100,
					texture_url:"./texture/venusmap.jpg",
					color_atmosphere:new THREE.Color(0x034d8e)});
	  _venus.create();
	...
	create_saturn(){
		let _saturn=new Planet({scene: this.Scene,radius:this._earth_radius/2,position:this._saturn_pos,
					altitude_atmosphere:100,
	...
	create_uranus(){
		let _uranus=new Planet({scene: this.Scene,radius:this._earth_radius*0.8,position:this._uranus_pos,
					altitude_atmosphere:100,
	...
	//plutomap1k
	create_pluto(){
		let _pluto=new Planet({scene: this.Scene,radius:this._earth_radius*0.2,position:this._pluto_pos,
					altitude_atmosphere:100,
