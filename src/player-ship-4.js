...
class PlayerShip4 extends PlayerEntity{
	constructor(params){
		...
		this._skills=['fire-breathing','light-shield','speed-up'];////speed-up phai de o cuoi cung
	...
	init_skills(){//overwrite
		this._main_skill_ids=[4,1001,1002];
	...
	create_fire_breathing_icon(_shipclass){
		/*
		...
		_rocket_icon.src="./resources/icons/missile-10.png";
		...
		*/
		const _rocket_icon_container=_shipclass.create_skill_icon(_shipclass,"./resources/icons/missile-10.png");
		...
		let _perform_fire_breathing_fc=()=>{
				...
				_shipclass.apply_fire_breathing_skill(_shipclass);
				
				_rocket_num--;
				
		};
		
		_shipclass.create_fire_breathing_icon._perform_fc=_perform_fire_breathing_fc;
