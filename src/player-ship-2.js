...
let _size=0.4;
class PlayerShip2 extends PlayerEntity{
	constructor(params){
		...
		//this._skills=['continuous-rockets','light-shield','speed-up'];////speed-up phai de o cuoi cung
	...
	init_skills(){//overwrite
		this._main_skill_ids=[2,1001,1002];
	...
	create_continuous_rocket_icon(_shipclass){//skill bắn rockets liên hoàn
		/*
		...
		_rocket_icon.src="./resources/icons/skills/Untitled2.png";
		...
		*/
		const _rocket_icon_container=_shipclass.create_skill_icon(_shipclass,"./resources/icons/skills/Untitled2.png");
		...
		let _perform_continuous_rockets_fc=()=>{
				...
				_shipclass.apply_continuous_rocket_skill(_shipclass);
				
				_rocket_num--;
				
		};
		_shipclass.create_continuous_rocket_icon._perform_fc=_perform_continuous_rockets_fc;
	...
	use_blaster_and_direction_custom(){
		...
		this._game._entities[this._thruster_id1] = new thruster.Thruster(//LIGHT OF ENGINE
        {
			...
			start_pos:new THREE.Vector3(_px,0.0,_pz),//z la len xuong
			end_pos:new THREE.Vector3(-_px,0.0,_pz)//y la vao trong/ra ngoai, x la trai' phai?
        });
		this._game._entities[this._thruster_id2] = new thruster.Thruster(//LIGHT OF ENGINE
        {
            ...
            texture: "./resources/blaster.jpg",
            visibility: this._game._visibilityGrid,
			start_pos:new THREE.Vector3(_px,-3,_pz),
			end_pos:new THREE.Vector3(-_px,-3,_pz)
        });
		*/
