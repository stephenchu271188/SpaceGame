/*đoạn mã này định nghĩa một module cung cấp hai lớp _CubicHermiteSpline và
 _LinearSpline, dùng để xây dựng các đường cong spline. 
 Chúng dùng lerp giữa các điểm dữ liệu để nội suy tuyến tính và có thể sử dụng 
 trong các ứng dụng thao tác với đường cong mượt mà. */
